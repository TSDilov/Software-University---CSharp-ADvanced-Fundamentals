function solution(action) {
    ...
    function score() {
        ...
        const scoreVotes = this.upvotes - this.downvotes;
        ...
        const report = [upvotesObfuscated, downvotesObfuscated, scoreVotes, rating.call(this)]
        ...
        function rating() {
            ...
            if (totalVotes < 10) {
                ...
                rating = 'hot';
            } else if (scoreVotes >= 0 && (this.upvotes > 100 || this.downvotes > 100)) {
                rating = 'controversial';
            } else if (scoreVotes < 0) {
                rating = 'unpopular';
            }
